...
file2_path = 'ingredient_vectors64.xlsx'
file3_path = 'dis_vectors64.xlsx'
...
#成分特征融合
# 文件路径
file_a_path_ingredient = 'ingredient_vectors64.xlsx'
...
#疾病特征融合
# 文件路径
file_a_path_dis = 'dis_vectors64.xlsx'
...
# 自动生成列名逻辑
# 获取文件A的列数，并生成递增列名（例如：文件A有3列，则文件B列名自动变为4）
auto_new_col = df_a.shape[1] + 1  # 自动计算新列起始值
